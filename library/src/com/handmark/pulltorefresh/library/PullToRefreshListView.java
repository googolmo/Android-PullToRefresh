...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void setLastUpdatedLabel(CharSequence label) {
        ...
        if (null != mFooterLoadingView && getMode().canPullUp()) {
...
//        super.onLoadMore(doScroll);
    ...
    void onResetFooter(CharSequence title) {
        ...
        // Set our Original View to Visible
        originalLoadingLayout.setVisibility(View.INVISIBLE);
        listViewLoadingLayout.setRefreshingLabel(title);
        listViewLoadingLayout.resetNone(title);
        listViewLoadingLayout.setVisibility(View.VISIBLE);
